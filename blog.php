		  ...
		  <span class="menu"> </span>
			<ul class="top-nav">
                <li><a href="contact.php">تماس با ما<span class="	glyphicon glyphicon-earphone"></span></a></li>
                 ...
                 <li class="active"><a href="blog.php">یادداشت ها<span class="	glyphicon glyphicon-edit"></span></a></li>
	       ...
	       <div class="col-md-9">
               <div class="panel panel-default">
                   ...
                   <div class="panel-body">
                       <?php
 $query_comment = "SELECT id,title_text,main_text FROM help_page ORDER BY id DESC";
               ...
               ?>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="container">
                            ...
                            <p class="text_justy">
                              <?php 
                         $a_main = substr($main_text , 0 ,350);
                  
                         echo $a_main . "...";
                                ?>
                            </p>
                            <p class="float_left">
                                <a href="blogpage.php?p=<?=$id?>" class="btn btn-primary btn-lg"> ادامه مطلب</a>
                            </p>
                        </div>
                    </div>
